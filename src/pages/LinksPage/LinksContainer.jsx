...
const LinksContainer = ({ links, setLinks, addAnalyticsEntry }) => {
  const incrementClickCount = async (id) => {
    ...
    try {
      ...
      // Dynamically update device-specific counters
      if (result.userDevice === "android") incrementDeviceClicks("Mobile");
      else if (result.userDevice === "ios") incrementDeviceClicks("Tablet");
      else if (result.userDevice === "windows") incrementDeviceClicks("Desktop");
